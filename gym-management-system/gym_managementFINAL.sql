...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2024 at 04:09 AM
...
CREATE TABLE `payment` (
  ...
  `PaymentDate` date DEFAULT NULL,
  `ChosenPlan` varchar(100) DEFAULT NULL,
...
(1, 'One Day', 1, 75.00),
(2, 'One Month', 30, 750.00),
(3, 'Three Months', 90, 2150.00),
(4, 'Six Months', 180, 4250.00),
(5, 'Twelve Months (One Year)', 365, 8500.00);
